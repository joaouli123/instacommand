...
import { Users, Eye, Heart, Calendar, TrendingUp, Minus } from "lucide-react"
...
export function StatsCards({ stats, loading }: { stats?: DashboardStats; loading?: boolean }) {
  const cards = [
    ...
    { title: "Engajamento médio", value: stats?.engagementRate ? `${stats.engagementRate.toLocaleString("pt-BR")} %` : "—", trend: stats?.engagementRate ? "Posts importados" : "Sincronize para calcular", icon: Heart, iconBg: "bg-pink-50 text-pink-600 border border-pink-100" },

...
const envSchema = z.object({
  ...
  // Use Meta's canonical web OAuth host. Mobile redirects to this host too,
  // but the canonical endpoint is the one supported by Login for Business.
  FB_OAUTH_HOST: z.string().default('www.facebook.com'),
